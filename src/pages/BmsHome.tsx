...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0f1a] via-[#1a2232] to-[#0a0f1a] text-white">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-[#1a2232]/90 backdrop-blur-lg z-50 border-b border-gray-700 shadow-xl">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <Link to="/login">
            <Button className="bg-gradient-to-r from-blue-500 to-purple-500 hover:scale-105 shadow-xl">Login</Button>
          </Link>
        </div>
      </nav>
      ...
      <section id="home" className="pt-32 pb-20 text-center relative">
        ...
        >
          <h1 className="text-5xl font-extrabold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-6">
          ...
          <div className="flex justify-center gap-4">
            <Link to="/login">
              <Button className="bg-gradient-to-r from-blue-500 to-purple-500 hover:scale-110 shadow-xl">Get Started</Button>
            </Link>
            <Button variant="outline" className="border-blue-400 text-blue-400 hover:bg-blue-500/20" onClick={() => scrollToSection("about")}>Learn More</Button>
          </div>
        </motion.div>
      </section>

      {/* About Section */}
      <section id="about" className="py-20 bg-gradient-to-br from-[#1a2232] to-[#0a0f1a]">
        <div className="container mx-auto px-6 text-center">
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.7 }}
            className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-6">
            Why Choose Blue Marlin System?
          </motion.h2>
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            {features.map((feature, index) => (
              <motion.div key={index} className="p-6 rounded-xl bg-[#273549]/80 hover:bg-[#314258]/90 transition-all shadow-xl"
